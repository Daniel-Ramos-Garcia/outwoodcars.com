...
$sql = "SELECT id, Marque, Model, VYear, Miles, Sold, Description1, Description2, Price, Pic1 FROM tbloutwoodlist WHERE Category = '6' ORDER BY Price DESC";

$result = $conn->query($sql);


?>    
    <title>Outwood Cars — Classic Vehicles</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    <div class="mywrapper">
    <div id="banner-pic">
        <img id="mbg" src="assets/images/classic-car-header.png" alt="" style="width:100%" />
    </div>
