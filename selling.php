...
<head>
	<title>Outwood Cars — Let us value your vehicle</title>
...
<body>
	<div class="mywrapper">
		<div id="banner-pic"> <img id="mbg" src="assets/images/selling-car-header.png" alt="" style="width:100%" /> </div>
		...
		<nav id="navm" class="navbar navbar-expand-sm navbar-light bg-transparent mt-md-4">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0 w-100">
					...
					<li class="nav-item active" id="menu"> <a class="nav-link" href="selling.php">SELLING</a> </li>
		...
		<div class="container-fluid mt-5">
			<div id="page-frame">
				<div class="row">
					<div class="col-md-12">
						<H2>Let us give you a valuation for your vehicle</H2> </div>
					<div class="col-md-4 onethird">
						<p>Give us a description of your vehicle and we'll get back to as soon as possible.</p>
					</div>
