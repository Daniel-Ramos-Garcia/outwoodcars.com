...
<body>
    <div class="mywrapper">
    <div id="banner-pic"> <img id="mbg" src="assets/images/contact-header.png" alt="" style="width:100%" /> </div>
    ...
    <nav id="navm" class="navbar navbar-expand-sm navbar-light bg-transparent mt-md-4">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0 w-100">
                ...
                <li class="nav-item active" id="menu"> <a class="nav-link" href="contact.php">CONTACT US</a> </li>
            </ul>
        </div>
    </nav>
            ...
            <div class="row">
                ...
                <div class="col-md-7 twothird">
                  <!--   <form name="ajax-form" id="ajax-form" action="assets/mail/mail-it.php" method="post"> -->
                        ...
                        <label for="message">Message: * <span class="contenterror" id="err-message"></span></label>
